...
: cr d# 13 emit-uart  d# 10 emit-uart  ;
d# 32 constant bl
: space bl emit ;
...
: asc_to_dec
    d# 255 and d# 48 - d# 15 and 
;
: hex1 d# 15 and dup d# 10 < if d# 48 else d# 55 then + emit-uart ;
: hex2
    dup 
    d# 4 rshift
    hex1 hex1
